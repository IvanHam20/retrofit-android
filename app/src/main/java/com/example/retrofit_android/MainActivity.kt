...
import com.example.retrofit_android.adapters.DogsAdapter
import com.example.retrofit_android.models.API
...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        apiCall.listaImagenesDePerrosPorRaza(raza.lowercase()).enqueue(object :
            Callback<ImagesBreed> {
            override fun onResponse(call: Call<ImagesBreed>, response: Response<ImagesBreed>) {
                val dogs = response.body()?.message
                Log.d("PRUEBAS", "Status de la respuesta ${response.body()?.status}")
